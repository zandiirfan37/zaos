...
local authority, workflow, matching skills/tools, assurance, and any material
prompt conflict. Preserve mission and constraints, but choose routine method.

The nearest project `AGENTS.md` owns local rules; then load only its relevant
